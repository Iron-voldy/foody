        ...
        <div class="row mt-1 mb-1">
            ...
            <div class="offset-lg-1 col-12 col-lg-4 align-self-start mt-2">
                ...
                ?>
                    ...
                    <span class="text-lg-start text-info"><b>Welcome </b><?php echo $data["fname"]; ?></span> |
            ...
            <div class="offset-lg-4 col-12 col-lg-3 align-self-end">
                <div class="row">
                    ...
                    <div class="col-2 col-lg-3 mt-2">
                        <div class="d-none d-lg-block">
                            <img src="./img/sl_logo.jpg" alt="" class="flag">
                        </div>
                    </div>

                    <div class="col-1 col-lg-3 mt-2">
                        <span class="text-start fw-bold">Sri Lanka</span>
                    </div>
